...
local backdropTbl = {bgFile = ShadowUF.addonPath .. "media\\textures\\backdrop", edgeFile = ShadowUF.addonPath .. "media\\textures\\backdrop", tile = true, tileSize = 1, edgeSize = 1}
...
function Indicators:OnLayoutApplied(frame)
	...
	indicator.stack:SetFont(ShadowUF.addonPath .. "media\\fonts\\Myriad Condensed Web.ttf", 12, "OUTLINE")
