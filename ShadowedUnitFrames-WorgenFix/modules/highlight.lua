...
function Highlight:OnEnable(frame)
	if( not frame.highlight ) then
		...
		frame.highlight.top:SetTexture(ShadowUF.addonPath .. "media\\textures\\highlight")
		...
		frame.highlight.left:SetTexture(ShadowUF.addonPath .. "media\\textures\\highlight")
		...
		frame.highlight.right:SetTexture(ShadowUF.addonPath .. "media\\textures\\highlight")
		...
		frame.highlight.bottom:SetTexture(ShadowUF.addonPath .. "media\\textures\\highlight")
