...
function Layout:CheckMedia()
	mediaPath[SML.MediaType.STATUSBAR] = loadMedia(SML.MediaType.STATUSBAR, ShadowUF.db.profile.bars.texture, ShadowUF.addonPath .. "media\\textures\\Aluminium")
	mediaPath[SML.MediaType.FONT] = loadMedia(SML.MediaType.FONT, ShadowUF.db.profile.font.name, ShadowUF.addonPath .. "media\\fonts\\Myriad Condensed Web.ttf")
...
SML = LibStub:GetLibrary("LibSharedMedia-3.0")
	SML:Register(SML.MediaType.FONT, "Myriad Condensed Web", ShadowUF.addonPath .. "media\\fonts\\Myriad Condensed Web.ttf")
	SML:Register(SML.MediaType.BORDER, "Square Clean", ShadowUF.addonPath .. "media\\textures\\ABFBorder")
SML:Register(SML.MediaType.BACKGROUND, "Chat Frame", "Interface\\ChatFrame\\ChatFrameBackground")
	SML:Register(SML.MediaType.STATUSBAR, "BantoBar", ShadowUF.addonPath .. "media\\textures\\banto")
	SML:Register(SML.MediaType.STATUSBAR, "Smooth",   ShadowUF.addonPath .. "media\\textures\\smooth")
	SML:Register(SML.MediaType.STATUSBAR, "Perl",     ShadowUF.addonPath .. "media\\textures\\perl")
	SML:Register(SML.MediaType.STATUSBAR, "Glaze",    ShadowUF.addonPath .. "media\\textures\\glaze")
	SML:Register(SML.MediaType.STATUSBAR, "Charcoal", ShadowUF.addonPath .. "media\\textures\\Charcoal")
	SML:Register(SML.MediaType.STATUSBAR, "Otravi",   ShadowUF.addonPath .. "media\\textures\\otravi")
	SML:Register(SML.MediaType.STATUSBAR, "Striped",  ShadowUF.addonPath .. "media\\textures\\striped")
	SML:Register(SML.MediaType.STATUSBAR, "LiteStep", ShadowUF.addonPath .. "media\\textures\\LiteStep")
	SML:Register(SML.MediaType.STATUSBAR, "Aluminium", ShadowUF.addonPath .. "media\\textures\\Aluminium")
	SML:Register(SML.MediaType.STATUSBAR, "Minimalist", ShadowUF.addonPath .. "media\\textures\\Minimalist")
