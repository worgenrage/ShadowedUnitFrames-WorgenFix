...
local function updateButton(id, group, config)
	...
	button.stack:SetFont(ShadowUF.addonPath .. "media\\fonts\\Myriad Condensed Web.ttf", 10, "OUTLINE")
	...
	button.border:SetTexture(ShadowUF.addonPath .. "media\\textures\\border-" .. ShadowUF.db.profile.auras.borderType)
	...
	button.stack:SetFont(ShadowUF.addonPath .. "media\\fonts\\Myriad Condensed Web.ttf", math.floor((config.size * 0.60) + 0.5), "OUTLINE")
