...
local soulsConfig = {max = 3, key = "soulShards", colorKey = "SOULSHARDS", powerType = Enum.PowerType.SoulShards, eventType = "SOUL_SHARDS", icon = ShadowUF.addonPath .. "media\\textures\\shard"}
