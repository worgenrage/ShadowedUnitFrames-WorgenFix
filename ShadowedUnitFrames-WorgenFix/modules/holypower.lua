...
local holyConfig = {max = 3, key = "holyPower", colorKey = "HOLYPOWER", powerType = Enum.PowerType.HolyPower, eventType = "HOLY_POWER", icon = ShadowUF.addonPath .. "media\\textures\\combo"}
