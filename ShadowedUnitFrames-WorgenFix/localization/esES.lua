...
L["Events"] = "Eventos"
L["Export"] = "Exportar"
L["Failed to load ShadowedUF_Options-WorgenFix, cannot open configuration. Error returned: %s"] = "Error intentando cargar ShadowedUF_Options-WorgenFix, no se pudo abrir la configuración. Error recibido: %s"
