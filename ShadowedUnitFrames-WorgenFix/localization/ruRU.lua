...
L["Failed to load ShadowedUF_Options-WorgenFix, cannot open configuration. Error returned: %s"] = "Не удалось загрузить ShadowedUF_Options-WorgenFix, невозможно открыть настройки. Ошибка: %s"
