...
L["Shadowed Unit Frames was originally created by Shadowed. This fork is based on v4.3.9-classic from the upstream project maintained by Hendrik Leppkes (Nevcairiel). WorgenFix compatibility modifications are by Christian Hamar."] = "Shadowed Unit Frames was originally created by Shadowed. This fork is based on v4.3.9-classic from the upstream project maintained by Hendrik Leppkes (Nevcairiel). WorgenFix compatibility modifications are by Christian Hamar."
...
L["Upstream source"] = "Upstream source"
L["WorgenFix source and releases"] = "WorgenFix source and releases"
