...
local L = {}
L["Active API mode: %s"] = "Active API mode: %s"
L["Auto"] = "Auto"
L["Client API mode"] = "Client API mode"
L["Client compatibility"] = "Client compatibility"
L["Credits"] = "Credits"
L["Christian Hamar maintains the WorgenFix modifications. They add WoW Classic Era 1.15.8 and 1.15.9 compatibility handling, safe fallbacks for changed Blizzard APIs and data, an adjustable client API mode, isolated SavedVariables, and fork-specific packaging and documentation. Aura filtering and normal SUF profile behavior are intentionally preserved."] = "Christian Hamar maintains the WorgenFix modifications. They add WoW Classic Era 1.15.8 and 1.15.9 compatibility handling, safe fallbacks for changed Blizzard APIs and data, an adjustable client API mode, isolated SavedVariables, and fork-specific packaging and documentation. Aura filtering and normal SUF profile behavior are intentionally preserved."
L["Exact upstream release used by this fork"] = "Exact upstream release used by this fork"
L["Fork version: v4.3.9-classic-worgenfix.10"] = "Fork version: v4.3.9-classic-worgenfix.10"
L["How this fork was created"] = "How this fork was created"
L["Legacy Classic UI"] = "Legacy Classic UI"
L["Modern Classic UI"] = "Modern Classic UI"
L["Original CurseForge project"] = "Original CurseForge project"
L["Original GitHub repository"] = "Original GitHub repository"
L["Maintained upstream repository"] = "Maintained upstream repository"
L["Project links"] = "Project links"
L["Selects which Blizzard UI API generation is preferred. Auto selects Modern Classic UI on interface 11508 or newer. Missing APIs always fall back safely. Reload the UI after changing this option."] = "Selects which Blizzard UI API generation is preferred. Auto selects Modern Classic UI on interface 11508 or newer. Missing APIs always fall back safely. Reload the UI after changing this option."
L["Shadowed Unit Frames is a highly configurable unit-frame addon originally created by Shadowed. It replaces or supplements Blizzard unit frames while preserving profiles, layouts, tags, auras, and the extensive configuration system familiar to SUF users."] = "Shadowed Unit Frames is a highly configurable unit-frame addon originally created by Shadowed. It replaces or supplements Blizzard unit frames while preserving profiles, layouts, tags, auras, and the extensive configuration system familiar to SUF users."
L["Shadowed Unit Frames - Worgen Fix"] = "Shadowed Unit Frames - Worgen Fix"
L["The original project"] = "The original project"
L["This unofficial fork was created from Shadowed Unit Frames v4.3.9-classic, published through the upstream project maintained by Hendrik Leppkes (Nevcairiel). The original addon structure, features, profiles, and internal ShadowUF identifiers remain intact wherever possible."] = "This unofficial fork was created from Shadowed Unit Frames v4.3.9-classic, published through the upstream project maintained by Hendrik Leppkes (Nevcairiel). The original addon structure, features, profiles, and internal ShadowUF identifiers remain intact wherever possible."
L["This is an unofficial compatibility fork. The original Shadowed Unit Frames project is marked All Rights Reserved."] = "This is an unofficial compatibility fork. The original Shadowed Unit Frames project is marked All Rights Reserved."
L["What WorgenFix changes"] = "What WorgenFix changes"
L["WorgenFix GitHub repository"] = "WorgenFix GitHub repository"
L["WorgenFix releases"] = "WorgenFix releases"
...
L["Failed to load ShadowedUF_Options-WorgenFix, cannot open configuration. Error returned: %s"] = "Failed to load ShadowedUF_Options-WorgenFix, cannot open configuration. Error returned: %s"
