...
L["Failed to load ShadowedUF_Options-WorgenFix, cannot open configuration. Error returned: %s"] = "Échec du chargement de ShadowedUF_Options-WorgenFix car impossible de charger la configuration. Erreur renvoyée : %s"
