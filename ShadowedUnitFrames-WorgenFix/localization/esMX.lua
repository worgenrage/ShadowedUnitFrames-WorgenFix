...
L["Failed to load ShadowedUF_Options-WorgenFix, cannot open configuration. Error returned: %s"] = "Fallo al cargar 'ShadowedUF_Options-WorgenFix', no se puede abrir la configuración, Error devuelto: %s"
