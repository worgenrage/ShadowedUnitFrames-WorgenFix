...
L["Failed to load ShadowedUF_Options-WorgenFix, cannot open configuration. Error returned: %s"] = "Laden von ShadowedUF_Options-WorgenFix fehlgeschlagen, die Konfiguration kann nicht geöffnet werden. Fehlermeldung: %s"
